        ...
        "causes": {
            "exchange_db_corruption": {
                ...
                "templates": [
                    ...
                    ("Outlook mailbox not responding",
                     "Outlook has stopped responding and I can't access my mailbox or send emails since {time}."),
                    ("Mailbox frozen, Outlook unresponsive",
                     "My mailbox seems frozen and Outlook is unresponsive, can't open folders or send anything."),
                    ("Exchange mailbox errors in Outlook",
                     "Getting mailbox corruption errors and Outlook keeps crashing when I try to check email since {time}."),
                ],
            },
            "mail_queue_backlog": {
        ...
        "causes": {
            "erp_server_crash": {
                ...
                "templates": [
                    ...
                    ("ERP crashing with server errors",
                     "The ERP application keeps crashing and showing internal server errors, page won't load properly since {time}."),
                    ("ERP extremely slow and crashing mid-use",
                     "ERP has become unusably slow and crashed on me while I was in the middle of entering data."),
                ],
            },
        ...
        "causes": {
            "core_switch_failure": {
                ...
                "templates": [
                    ...
                    ("Network down, can't reach shared drives",
                     "Whole office network is down, wifi and LAN both affected, and shared drives are unreachable too."),
                    ("Wifi and network connectivity down across office",
                     "Wired and wireless connections both keep dropping, and I can't reach any internal systems or shared drives."),
                ],
            },
        ...
        "causes": {
            "storage_sync_outage": {
                ...
                "templates": [
                    ...
                    ("Cloud storage sync errors and upload failures",
                     "Cloud storage is showing sync errors and every file upload attempt fails since {time}."),
                    ("Shared cloud files stuck syncing",
                     "Shared cloud folder isn't updating and my files are stuck on 'syncing' with no progress."),
                ],
            },
        ...
        "causes": {
            "print_server_crash": {
                ...
                "templates": [
                    ...
                    ("Print jobs stuck, printers offline",
                     "All the office printers show offline and print jobs are stuck in the queue, nothing is printing since {time}."),
                    ("Cannot print, printers not responding",
                     "None of the shared printers are responding, everyone's print jobs are stuck and nothing comes out."),
                ],
            },
